#!/bin/sh
echo
echo "[RFSH] Job 30969f5a-6369-11ee-a32e-f297ad799bdb"
echo
RUN_DIR="$(mktemp -d)"
...
echo
echo  | base64 --decode > ${RUN_DIR}/testtemplate

# --export-template
echo '[RFSH] Building exports template...'
echo
echo  | base64 --decode > ${RUN_DIR}/exporttemplate

# run
echo '[RFSH] Running job...'
echo
${runflow_sh} basic -i ${RUN_DIR}/input -t ${RUN_DIR}/template --concurrent 4 --retries 0 --test-template ${RUN_DIR}/testtemplate --export-template ${RUN_DIR}/exporttemplate
echo '[RFSH] Done'
